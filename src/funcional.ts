...
const getBioByIdFuncional = (id: number) => {
...
const updateItemByIdFuncional = (id: number, name?: string, bio?: string) => {
  const item = lista.find(obj => obj['id'] === id)
  if (item) {
